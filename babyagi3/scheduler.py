...
class Scheduler:
        ...
        while self._running:
            try:
                ...
                if next_wake is None:
                    # No tasks scheduled - wait for wake event or 60s
                    try:
    ...
    def _reschedule_timer(self):
        """Wake the timer loop to recalculate next run time."""
